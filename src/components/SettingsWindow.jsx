...
const SettingsWindow = ({
    ...
    const handleModelChange = (e) => {
        ...
        setPrimaryModel(newVal);
        socket.emit('update_settings', { primary_model: newVal });
    };
    ...
    return (
        <div className="absolute top-5 right-5 bg-black/90 border border-cyan-500/50 p-4 rounded-lg z-[100] w-85 backdrop-blur-2xl shadow-[0_0_40px_rgba(6,182,212,0.3)] flex flex-col max-h-[90vh]">
            <div className="flex justify-between items-center mb-4 border-b border-cyan-900/50 pb-2 flex-shrink-0">
            ...
            <div className="overflow-y-auto pr-3 custom-scrollbar flex-grow space-y-6 overscroll-contain">
                ...
                <div className="mb-6">
                    <div className="flex justify-between items-center mb-2">
                        <h3 className="text-cyan-400 font-bold text-xs uppercase tracking-wider opacity-80">AI Model</h3>
                        <button 
                            onClick={() => socket.emit('get_available_models')}
                            className="text-[10px] text-cyan-600 hover:text-cyan-400 flex items-center gap-1 transition-colors"
                    ...
                    >
                        {availableModels.length > 0 ? (
                            ...
                            <>
                                ...
                                <option value="claude-3.5-sonnet">Claude 3.5 Sonnet (Copilot)</option>
                            </>
                        )}
                    </select>
                </div>
